...
var CeilingFanMediumCommand =
/*#__PURE__*/
function (_Command) {
  _inherits(CeilingFanMediumCommand, _Command);

  function CeilingFanMediumCommand(ceilingFan) {
    var _this;

    _classCallCheck(this, CeilingFanMediumCommand);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CeilingFanMediumCommand).call(this));
    _this.ceilingFan = ceilingFan;
    _this.prevLevel = null;
    return _this;
  }

  _createClass(CeilingFanMediumCommand, [{
    key: "execute",
