...
var CeilingFanOffCommand =
/*#__PURE__*/
function (_Command) {
  _inherits(CeilingFanOffCommand, _Command);

  function CeilingFanOffCommand(ceilingFan) {
    var _this;

    _classCallCheck(this, CeilingFanOffCommand);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CeilingFanOffCommand).call(this));
    _this.ceilingFan = ceilingFan;
    _this.prevLevel = null;
    return _this;
  }

  _createClass(CeilingFanOffCommand, [{
    key: "execute",
