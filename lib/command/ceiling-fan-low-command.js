...
var CeilingFanLowCommand =
/*#__PURE__*/
function (_Command) {
  _inherits(CeilingFanLowCommand, _Command);

  function CeilingFanLowCommand(ceilingFan) {
    var _this;

    _classCallCheck(this, CeilingFanLowCommand);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CeilingFanLowCommand).call(this));
    _this.ceilingFan = ceilingFan;
    _this.prevLevel = null;
    return _this;
  }

  _createClass(CeilingFanLowCommand, [{
    key: "execute",
