...
var CeilingFanHighCommand =
/*#__PURE__*/
function (_Command) {
  _inherits(CeilingFanHighCommand, _Command);

  function CeilingFanHighCommand(ceilingFan) {
    var _this;

    _classCallCheck(this, CeilingFanHighCommand);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CeilingFanHighCommand).call(this));
    _this.ceilingFan = ceilingFan;
    _this.prevLevel = null;
    return _this;
  }

  _createClass(CeilingFanHighCommand, [{
    key: "execute",
