...
var ChicagoStyleCheesePizza =
/*#__PURE__*/
function (_Pizza) {
  _inherits(ChicagoStyleCheesePizza, _Pizza);

  function ChicagoStyleCheesePizza() {
    var _this;

    _classCallCheck(this, ChicagoStyleCheesePizza);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ChicagoStyleCheesePizza).call(this));
  ...
  _createClass(ChicagoStyleCheesePizza, [{
    key: "cut",
    value: function cut() {
