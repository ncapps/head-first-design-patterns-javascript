...
function (_CondimentDecorator) {
  _inherits(Whip, _CondimentDecorator);

  function Whip(beverage) {
    var _this;

    _classCallCheck(this, Whip);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Whip).call(this));
  ...
  _createClass(Whip, [{
    ...
    value: function getDescription() {
      return "".concat(this.beverage.getDescription(), ", Whip");
    }
  }, {
    key: "cost",
    value: function cost() {
