...
function (_CondimentDecorator) {
  _inherits(Mocha, _CondimentDecorator);
  ...
  function Mocha(beverage) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Mocha).call(this));
  ...
  _createClass(Mocha, [{
    ...
    value: function getDescription() {
      return "".concat(this.beverage.getDescription(), ", Mocha");
    }
  }, {
    key: "cost",
    value: function cost() {
