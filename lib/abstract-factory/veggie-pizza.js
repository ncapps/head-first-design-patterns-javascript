...
/*#__PURE__*/
function (_Pizza) {
  _inherits(VeggiePizza, _Pizza);

  function VeggiePizza(ingredientFactory) {
    var _this;

    _classCallCheck(this, VeggiePizza);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(VeggiePizza).call(this));
    _this.ingredientFactory = ingredientFactory;
    return _this;
  }

  _createClass(VeggiePizza, [{
    key: "prepare",
