...
/*#__PURE__*/
function (_Pizza) {
  _inherits(CheesePizza, _Pizza);

  function CheesePizza(ingredientFactory) {
    var _this;

    _classCallCheck(this, CheesePizza);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CheesePizza).call(this));
    _this.ingredientFactory = ingredientFactory;
    return _this;
  }

  _createClass(CheesePizza, [{
    key: "prepare",
