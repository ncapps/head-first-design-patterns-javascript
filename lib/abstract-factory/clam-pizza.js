...
/*#__PURE__*/
function (_Pizza) {
  _inherits(ClamPizza, _Pizza);

  function ClamPizza(ingredientFactory) {
    var _this;

    _classCallCheck(this, ClamPizza);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ClamPizza).call(this));
    _this.ingredientFactory = ingredientFactory;
    return _this;
  }

  _createClass(ClamPizza, [{
    key: "prepare",
